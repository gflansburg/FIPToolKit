...
{
    public abstract class FIPNonLinearAnalogGauge : FIPAnalogGauge
    {
        public List<NonLinearSetting> NonLinearSettings { get; set; }

        public FIPNonLinearAnalogGauge(FIPAnalogGaugeProperties properties, FlightSimProviderBase flightSimProvider) : base(properties, flightSimProvider)
        {
