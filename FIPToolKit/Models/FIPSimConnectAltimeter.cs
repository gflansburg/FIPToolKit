					...
					if (gauge != null)
					{
						...
						using (Graphics grfx = Graphics.FromImage(bmp))
						{
							...
							if (ShowKollsmanWindow)
							{
								...
								{
									string text = string.Format("{0:0.00}", SimConnect.CurrentWeather.KollsmanHG);
				...
				using (Pen pen = new Pen(InnerRimColor, 2))
                {
					...
					if (GaugeImage == null)
					{
						...
						using (Font font = new System.Drawing.Font(Font.FontFamily, 5.5f, FontStyle.Regular, GraphicsUnit.Point))
						{
							...
							grfx.DrawRotatedTextAt(-21, "1000", midx - 25, 55f, font, stringBrush);
							grfx.DrawRotatedTextAt(21, "FEET", midx + 25, 55f, font, stringBrush);

							grfx.DrawRotatedTextAt(-21, "10000", midx - 25, 65f, font, stringBrush);
							grfx.DrawRotatedTextAt(21, "FEET", midx + 25, 65f, font, stringBrush);
