...
namespace FIPDisplayProfiler
{
    public partial class AnalogGaugeForm : Form
    {
        ...
        {
            AnalogGauge.Font = _fontHolder;
            AnalogGauge.FontColor = btnFontColor.BackColor;
            AnalogGauge.IsDirty = true;
        ...
        private void AnalogGaugeForm_Load(object sender, EventArgs e)
        {
            _fontHolder = AnalogGauge.Font;
            tbFont.Font = new Font(AnalogGauge.Font.FontFamily, tbFont.Font.Size, AnalogGauge.Font.Style, AnalogGauge.Font.Unit, AnalogGauge.Font.GdiCharSet);
            tbFont.Text = AnalogGauge.Font.FontFamily.Name;
            btnFontColor.BackColor = AnalogGauge.FontColor;
        }
    }
}
