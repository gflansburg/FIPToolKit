...
namespace FIPToolKit.Tools
{
    public static class KeyModifiers
    {
        ...
        public static string GetVirtualKeyCodesAsString(HashSet<VirtualKeyCode> virtualKeyCodes)
        {
            HashSet<string> hashSetOfKeysPressed = new HashSet<string>();
            ...
            return KeyModifiers.RemoveRControl(result);
        }
    }
}
