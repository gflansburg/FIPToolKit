...
namespace FIPToolKit.Tools
{
    public class Null
    {
        ...
        public static uint SetNullUInt(object objValue)
        {
            return objValue != DBNull.Value ? Convert.ToUInt32(objValue) : NullUInt;
        }

        public static long SetNullLong(object objValue)
        {
            return objValue != DBNull.Value ? Convert.ToInt64(objValue) : NullLong;
        }
        ...
        {
            return objValue != DBNull.Value ? Convert.ToDouble(objValue) : NullDouble;
        }
